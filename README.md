### To run, have docker up and running, install requirements.txt, then run the scripts in the scripts folder in sequential order (ingest_fda.py, process_fda.py, run_pipeline.py, visualize_fda.py). 
